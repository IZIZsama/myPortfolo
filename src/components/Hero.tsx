...
const Hero: React.FC = () => {
  ...
  const handleDownloadCV = () => {
    ...
    link.href = '/cv.pdf';
    link.download = 'CV_TaroTanaka.pdf';
    link.click();
  };
  ...
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-emerald-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800">
      <div ref={heroRef} className={`max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center transition-all duration-1000 ${
        ...
        <div className="mb-8">
          <div className="w-32 h-32 rounded-full bg-gradient-to-r from-blue-600 to-emerald-600 mx-auto mb-8 flex items-center justify-center text-white text-4xl font-bold shadow-xl">
            TT
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          <button
            ...
            className="inline-flex items-center px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
          >
